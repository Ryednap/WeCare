...
abstract class TopCardView {
  ...
  static List<Widget> _buildSalutation() {
    return [
      Text(
        "Hey Monica,",
  ...
  static List<Widget> _buildMedicationProgress() {
    return [
      SizedBox(
        width: 60.w,
  ...
  static Widget buildTopCard(BuildContext context) {
    return Container(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: _buildMedicationProgress()
                      ),
                    ),
                  ],
                ),
